...
import { Building2, Calendar, Home, User, Contact } from 'lucide-react';
...
const navigation = [
  { name: 'Dashboard', href: '/dashboard/company', icon: Home },
  {
    ...
    href: '/dashboard/company/cleaning-request',
    icon: Calendar,
  },
  { name: 'Profile', href: '/dashboard/company/profile', icon: User },
];
      ...
      <div className="hidden border-r bg-card md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
        <div className="flex flex-grow flex-col overflow-y-auto">
          ...
          <div className="flex h-16 flex-shrink-0 items-center px-4">
            ...
            <span className="ml-2 text-md font-semibold">Role: Company</span>
          </div>
